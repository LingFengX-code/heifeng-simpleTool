...
import com.heifeng.generator.entity.Column;
import com.heifeng.generator.entity.DataBase;
import com.heifeng.generator.entity.Table;
...
public class DataBaseUtils {
    ...
    public static List<Table> getDbInfo(DataBase db) throws  Exception {
        ...
        while (tables.next()) {
            ...
            String keys = "";
            while (primaryKeys.next()) {//如果是复合主键的话
                String keyname = primaryKeys.getString("COLUMN_NAME");  //主键的列名
                keys += keyname+",";
            }
    ...
    public static void main(String[] args) throws Exception {
        DataBase db = new DataBase("MYSQL","zhaobiao");
        db.setUserName("root");
        db.setPassWord("xlf19990105");
