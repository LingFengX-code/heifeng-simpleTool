...
package com.heifeng.generator.ui;


import com.heifeng.generator.core.GeneratorFacade;
...
//												.addComponent(jTextField4)
	...
	private void formWindowOpened(java.awt.event.WindowEvent evt) {
		...
		File directory = new File(new File("").getAbsolutePath() + "\\" +PropertiesUtils.MODDLE_NAME + "模板");//设定为当前文件夹
			  ...
			  public void run(){
				  try{
					//路径map封装
						...
						//获取当前文件夹下的模板目录下的所有文件夹
						String basePath = new File("").getAbsolutePath() + "\\" +PropertiesUtils.MODDLE_NAME +"模板\\"
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				new CodeUtil(db,"zhaobiao").setVisible(true);*/
			}
		});
	}
